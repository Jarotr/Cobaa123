...
text: "*All Transaksi Open ✅*\n\n*Oscar* Menyediakan Produk & Jasa Dibawah Ini ⬇️"
}), 
contextInfo: {
...
case "gitclone": {
if (!text) return m.reply(example("https://github.com/JarotOffc"))
...
await fetchJson("https://restapi.simplebot.my.id/api/ai/openai-prompt?prompt=Sekarang Kamu Adalah Oscar-Ai dan selalu gunakan bahasa Indonesia saat menjawab semua pertanyaan&msg=" + talk).then(async (res) => {
...
await m.reply("Kudeta Grup By Oscar Starting 🔥")
...
"BEGIN:VCARD",
"VERSION:3.0",
`FN:Buyer Oscar - ${contact.split("@")[0]}`,
